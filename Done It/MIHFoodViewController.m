...
#import "MIHFoodViewController.h"
#import <QuartzCore/QuartzCore.h>
#import "MIHFoodCell.h"
#import <Parse/Parse.h>
#import "SDWebImage/UIImageView+WebCache.h"
#import "MIHExperienceDetailViewController.h"


@interface MIHFoodViewController ()


@end

@implementation MIHFoodViewController
...
- (void)viewDidLoad
{
    ...
    _headerView.backgroundColor = [UIColor colorWithRed:40.0/255 green:101.0/255 blue:175.0/255 alpha:1.0];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MIHFoodCell *cell = (MIHFoodCell*) [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    cell.mainPicView.layer.cornerRadius = cell.mainPicView.frame.size.width/2;
    cell.mainPicView.layer.masksToBounds = YES;
    
   
    PFObject *thisObj = [foodFeed objectAtIndex:indexPath.row];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if([segue.identifier isEqualToString:@"showFoodDetail"]){
        ...
        PFObject *thisobject = [foodFeed objectAtIndex:[self.myTableView indexPathForSelectedRow].row];
