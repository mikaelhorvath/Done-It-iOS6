...
#import "MIHWaterViewController.h"
#import "MIHWaterCell.h"
#import <QuartzCore/QuartzCore.h>
#import <Parse/Parse.h>
#import "SDWebImage/UIImageView+WebCache.h"
#import "MIHExperienceDetailViewController.h"

@interface MIHWaterViewController ()

@end

@implementation MIHWaterViewController
...
- (void)viewDidLoad
{
    ...
    _headerView.backgroundColor = [UIColor colorWithRed:151.0/255 green:210.0/255 blue:223.0/255 alpha:1.0];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MIHWaterCell *cell = (MIHWaterCell*) [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];

    cell.mainPicView.layer.cornerRadius = cell.mainPicView.frame.size.width/2;
    cell.mainPicView.layer.masksToBounds = YES;

    PFObject *thisObj = [waterFeed objectAtIndex:indexPath.row];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if([segue.identifier isEqualToString:@"showWaterDetail"]){
        
        MIHExperienceDetailViewController* nvc = (MIHExperienceDetailViewController*)[segue destinationViewController];
        
        
        PFObject *thisobject = [waterFeed objectAtIndex:[self.myTableView indexPathForSelectedRow].row];
