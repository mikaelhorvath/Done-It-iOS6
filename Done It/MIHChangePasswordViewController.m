//
//  MIHChangePasswordViewController.m
//  Done It
//
...
#import "MIHChangePasswordViewController.h"
#import <Parse/Parse.h>
#import <QuartzCore/QuartzCore.h>

@interface MIHChangePasswordViewController ()

@end

@implementation MIHChangePasswordViewController
...
- (void)viewDidLoad
{
    ...
    _changeBtn.backgroundColor = [UIColor colorWithRed:41.0/255 green:171.0/255 blue:226.0/255 alpha:1.0];
...
- (IBAction)changeBtnClicked:(UIButton *)sender {
    ...
    [currentUser setPassword:_passField.text];
